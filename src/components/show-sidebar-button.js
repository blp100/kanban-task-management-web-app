...
const IconShowSidebar = createIcon({
  displayName: "IconShowSidebar",
  viewBox: "0 0 16 11",
...
const ShowSidebarButton = ({ onOpen, ...otherProps }) => {
  return (
    <Box
      display="flex"
      alignItems="center"
      ...
      cursor="pointer"
      onClick={onOpen}
      _hover={{ bgColor: "mainPurpleHover" }}
      {...otherProps}
    >
      <IconShowSidebar alt="Show Sidebar Icon" color="white" ml="18px" />
    </Box>
  );
};
